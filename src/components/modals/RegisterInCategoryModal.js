...
function RegisterInCategoryModal() {
  ...
  return (
    <div className="ccm">
      ...
      <button onClick={() => setOpen(true)}>Register In Category</button>
      ...
      <Modal
        ...
        <div style={modalStyle} className={classes.paper}>
          <form className="ccm__registerincategory">
            <center>
...
export default RegisterInCategoryModal;
